...
function ResearchSection() {
  ...
  return (
    <Container fluid className='mb-0 mt-0'>
      <h1 className={`pb-0 montserrat research-section-title  ${myRefIsVisible ? "divslide" : ""}`} ref={myRef}>Research</h1>
      <Row className="d-flex align-items-center justify-content-center mx-0 gx-5">
        <Col xl={6} >
          <Row className='d-flex align-items-center justify-content-center '>
            <h3 className={`text-center topics mb-xl-0 mb-xxl-3 ${myRef1IsVisible ? "divslide" : ""}`} ref={myRef1}>Topics</h3>
            
            <Col sm={5} className='row-research research-photo mb-lg-3 mb-xl-0'>
              <div className={`research-photo-container ${myRef1IsVisible ? "divslide" : ""}`} ref={myRef1}>
        ...
        <Col xl={6}>
          <Row className='d-flex align-items-center justify-content-center'>
            <h3 className={`text-center methods mt-3 mt-lg-0 mb-xl-0 mb-xxl-3 ${myRef4IsVisible ? "divslide" : ""}`} ref={myRef4}>Methods</h3>
            <Col sm={5} className='row-research research-photo mb-lg-3 mb-xl-0'>
              <div className={`research-photo-container ${myRef4IsVisible ? "divslide" : ""}`} ref={myRef4}>
