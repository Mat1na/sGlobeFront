    ...
    return (<>
        ...
        <Container fluid className='mt-0'>
            ...
            <div className={`join-bg ${myJoin2IsVisible ? "divslide2" : ""}`} ref={myJoin2}>
                ...
                <p className='roboto paragraphtext'> I am seeking highly motivated candidates for <a href='https://www.kuleuven.be/personeel/jobsite/jobs/60349364?lang=en' target='_blank' rel='noreferrer' className='join-link'>two PhD positions</a> on my ERC-funded FutureNature project. Deadline for application is 15th of August 2024. Have a look at <Link to="/#research" className='join-link'>Research</Link> and our <Link to="/#projects" className='join-link'>Research projects</Link> to see what we are doing. So if you are interested in applying for a PhD or postdoc fellowship, you are always welcome to contact me. The different opportunities are listed below.
                </p>
