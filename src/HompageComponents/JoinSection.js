    ...
    return (<>
        ...
        <Container fluid className='mt-0'>
            ...
            <div className={`join-bg ${myJoin2IsVisible ? "divslide2" : ""}`} ref={myJoin2}>
                ...
                <h2 className="montserrat join-title4">Open vacancies</h2>
                <p className='roboto paragraphtext'> I am seeking highly motivated candidates for two job openings on my ERC-funded FutureNature project: One <a href='https://www.kuleuven.be/personeel/jobsite/jobs/60214400' target='_blank' rel='noreferrer' className='join-link'>PhD researcher</a> who will work on the contribution of neophyte species to biodiversity and ecosystem functioning and one <a href='https://www.kuleuven.be/personeel/jobsite/jobs/60214433' target='_blank' rel='noreferrer' className='join-link'>postdoc</a> who will work on assisted migration of plant species to shape future functional ecosystems. Deadline for application is 8th of June 2023. Have a look at <Link to="/#research" className='join-link'>Research</Link> and our <Link to="/#projects" className='join-link'>Research projects</Link> to see what we are doing. So if you are interested in applying for a PhD or postdoc fellowship, you are always welcome to contact me. The different opportunities are listed below.
                </p>
